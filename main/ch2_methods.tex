...
\chapter{Physical models of renewable energy technologies}
...
\section{Solar PV and solar thermal energy}
...
\subsection{Available area for PV installation}

\subsection{PV module and inverter efficiency}
...
\begin{figure}
    ...
    \caption{Example for the variation in ground temperature for two measurements of ground temperature in Zürich, showing the influence of altitude and additional surface heating. \citep{huber_bodentemperaturen_2014}.}
    \label{fig:T_ground}
\end{figure}
...
\begin{figure}
    ...
    \caption{Map of geothermal heat flows in Switzerland \citep{huber_bodentemperaturen_2014}.}
    \label{fig:q_geo}
\end{figure}
...
\begin{figure}[b]
    ...
    \caption{Cross-section of a duplex BHE layout \citep{wagner_erdsondenpotenzial_2014}.}
...
\section{Geographic Information Systems processing}
...
% EQUATIONS 3 and 4 IN ICAE paper
