...
% [TO DOS]
% [DAN: FIX ISSUE WITH CITATION (MULTIPLY DEFINED)]
...
\label{intro_goals}
%% RESEARCH QUESTIONS BRAINSTORIMING

% 3 questions:
% part 1; tech. potential for solar, with 2 sub-questions (pot, uncertainty)
% part 2: tech. potential for geothermal, different methodological focus
% part 3: hybrid
% --> Table (key research question, with section numbers)

% OR: 2 research questions for potential (addressed for solar and geothermal)
% + 1 research question for hybrid (how datasets can be used for hybrid studeis)
