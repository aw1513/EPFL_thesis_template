...
\section{Physical potential estimation}
\label{solar_phys}
...
\section{Geographical potential estimation}
\label{solar_geo}

\subsection{Available area for solar panel installation}

\subsection{Solar radiation on tilted surfaces}

\section{Technical potential estimation}
\label{solar_tech}
